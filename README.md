...
- If you overwrite a key to a device that's actively in use (for some reason), windows stores the active key in memory even after refreshing. Linux should update immidiately after a reload, but windows will require a reboot.
